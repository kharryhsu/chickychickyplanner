      ...
      builder: (context) {
        return StatefulBuilder(
          builder: (context, setState) {
            return AlertDialog(
              title: Text(_editedTask == null ? 'New Task' : 'Edit Task',style: const TextStyle(
=======
  showDialog(
    context: context,
    builder: (context) {
        ...
        builder: (context, setState) {
          return AlertDialog(
            title: Text(
              ...
              style: TextStyle(
>>>>>>> c4f994aa55b7dfdcfcd74060ac6e565579262854
...
<<<<<<< HEAD
                  ...
                  ListTile(
                    title: Text(
                      _selectedDate == null
                          ? 'No due date chosen'
                          : 'Due Date: ${_selectedDate!.toLocal().toString().split(' ')[0]}',style: const TextStyle(fontSize: 12
                          ),
                    ),
                    trailing: IconButton(
                      icon: const Icon(Icons.calendar_today),
